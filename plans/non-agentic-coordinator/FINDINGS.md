...
| 2026-09-20 | 🐞 | Parked worker narrated "waiting for the coordinator's answer" — stale down-channel (§2.2: coordinator sends nothing). `pir-worker` step 2 tightened (T09, PM): address the person, never the coordinator. Live re-proof pending. |
