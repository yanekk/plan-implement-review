...
| T06 | reap-workers | T04, T05 | ✅ | Review clean, no fix commit. Recorded deviations accepted. Probed: a real TERM-ignoring child is SIGKILLed at 3 s and a mismatched-lstart pid skipped (script against real processes); stopRun reaps after the coordinator dies on all three paths; removeRun spares other control files; no `claude agents` listing remains. |
